...
def create(incidente: schemas.Incidentes = Body(default=None), db: Session = Depends(database.get_db)):
    if not incidente:
    ...
    elif not incidente.descripcion or not incidente.estado or not incidente.fechacreacion or not incidente.gestorabc or not incidente.cliente or not incidente.usuario or not incidente.comentarios:
        ...
        return {
            ...
            "GESTORABC": new_incidente.GESTORABC,
